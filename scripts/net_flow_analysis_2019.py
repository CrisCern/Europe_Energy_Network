...
net_flow.to_csv("../metrics_2019/net_flow_from_export_only_2019.csv")

# === 6. Output a schermo ===
print("\n🔝 Top 5 esportatori netti (surplus) - 2019:")
print(net_flow.sort_values("balance_MWh", ascending=False).head(5))

print("\n🔻 Top 5 importatori netti (deficit) - 2019:")
